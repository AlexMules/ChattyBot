...
namespace ChattyBot.Tests.Server.BotEngine
{
    public class BotEngineTests
    {
        ...
        public BotEngineTests()
        {
            ...
            _sut = new ChattyBot.Server.Application.BotEngine.BotEngine(_mockCommands, _context);
        }

        [Fact]
        public void GetWelcomeMessage_ShouldReturnPersonalizedGreeting()
        {
            var result = ChattyBot.Server.Application.BotEngine.BotEngine.GetWelcomeMessage("Alex");
