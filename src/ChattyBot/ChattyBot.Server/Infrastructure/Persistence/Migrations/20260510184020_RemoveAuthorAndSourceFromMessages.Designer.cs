...
namespace ChattyBot.Server.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260510184020_RemoveAuthorAndSourceFromMessages")]
    partial class RemoveAuthorAndSourceFromMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChattyBot.Server.Domain.Entities.ChatConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChattyBot.Server.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChattyBot.Server.Domain.Entities.ChatConversation", b =>
                {
                    b.HasOne("ChattyBot.Server.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ChattyBot.Server.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("ChattyBot.Server.Domain.Entities.ChatConversation", "ChatConversation")
                        .WithMany("Messages")
